...
<div class="page-body">
    <div class="row">
        <div class="col-md-12">
            <h4>&nbsp;<i class="fa fa-chevron-circle-right"></i>&nbsp;Products Type</h4>
            <div class="card">
                <div class="card-header card_head_modify">
                    <div class="row mt-2">
                        <div class="col-md-10">
                            <h5 class="pull-left pt-1" style="font-size: 18px;">Products Type</h5>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="dt-responsive table-responsive">
                            <table id="table_data" style="width:100%;" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody class="tbody_txt_center">
                                    @foreach ($product_type as $item => $value)
                                    <tr>
                                        <td>{{ $item+1 }}</td>
                                        <td>
                                            <p class="text-left">{!! isset($value) ? $value->product_type_name : '' !!}</p>
                                        </td>
                                        <td>
                                            <div class="row">
                                                <div class="offset-4 col-1">
                                                    <a href="{{ url('product_type/edit/'.$value->id) }}">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width:50%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Products Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {{ Form::open(['url'=>['product_type/store'],'id'=>'gen_form','autocomplete'=>'off','enctype'=>'multipart/form-data']) }}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="product_type_name" id="product_type_name" required value="" class="form-control" placeholder="Title">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label text-right">Detail : </label>
                                <div class="col-md-10">
    ...
    <script type="text/javascript">
        ...
        function modal() {
            $('#gen_form').attr('action', "{!! url('product_type/store') !!}");
            $('#submit').text('Save');
        ...
        function del_user(id) {
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        type: "GET",
                        url: "{!! url('product_type/delete/" + id + "') !!}",
