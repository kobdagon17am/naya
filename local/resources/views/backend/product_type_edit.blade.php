    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                {{ Form::open(['url'=>['product_type/update'],'id'=>'gen_form','autocomplete'=>'off','enctype'=>'multipart/form-data']) }}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="product_type_name" id="product_type_name" required value="{{ isset($product_type) ? $product_type->product_type_name : '' }}" class="form-control" placeholder="Title" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control summernote_ed1" rows="5" name="detail" id="detail" placeholder="Text">{!! isset($product_type) ? $product_type->detail : '' !!}</textarea>
                                </div>
                            </div>
                        </div>
